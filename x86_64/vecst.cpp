...
/* Direct Python call wrappers to density mechanism functions.*/
 static double _npy_AAA(Prop*);
 static double _npy_Expo(Prop*);
 static double _npy_fac(Prop*);
 static double _npy_install_vecst(Prop*);
 static double _npy_logfac(Prop*);
 static double _npy_vseed(Prop*);
 
static NPyDirectMechFunc npy_direct_func_proc[] = {
 {"AAA", _npy_AAA},
 {"Expo", _npy_Expo},
 {"fac", _npy_fac},
 {"install_vecst", _npy_install_vecst},
 {"logfac", _npy_logfac},
 {"vseed", _npy_vseed},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _vecst_reg() {
	int _vectorized = 0;
  _initlists();
 
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 vecst /home/ethan/nuerontest/vecst.mod\n");
 }
...
static double _npy_fac(Prop* _prop) {
    double _r{0.0};
    neuron::legacy::set_globals_from_prop(_prop, _ml_real, _ml, _iml);
  _ppvar = _nrn_mechanism_access_dparam(_prop);
 _r =  fac (  *getarg(1) );
...
static double _npy_logfac(Prop* _prop) {
    double _r{0.0};
    neuron::legacy::set_globals_from_prop(_prop, _ml_real, _ml, _iml);
  _ppvar = _nrn_mechanism_access_dparam(_prop);
 _r =  logfac (  *getarg(1) );
...
static double _npy_Expo(Prop* _prop) {
    double _r{0.0};
    neuron::legacy::set_globals_from_prop(_prop, _ml_real, _ml, _iml);
  _ppvar = _nrn_mechanism_access_dparam(_prop);
  _r = 1.;
...
static double _npy_AAA(Prop* _prop) {
    double _r{0.0};
    neuron::legacy::set_globals_from_prop(_prop, _ml_real, _ml, _iml);
  _ppvar = _nrn_mechanism_access_dparam(_prop);
 _r =  AAA (  *getarg(1) );
...
static double _npy_install_vecst(Prop* _prop) {
    double _r{0.0};
    neuron::legacy::set_globals_from_prop(_prop, _ml_real, _ml, _iml);
  _ppvar = _nrn_mechanism_access_dparam(_prop);
 _r = 1.;
...
static double _npy_vseed(Prop* _prop) {
    double _r{0.0};
    neuron::legacy::set_globals_from_prop(_prop, _ml_real, _ml, _iml);
  _ppvar = _nrn_mechanism_access_dparam(_prop);
 _r = 1.;
