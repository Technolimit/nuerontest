...
#define nrn_init _nrn_init__Exp2Test
#define _nrn_initial _nrn_initial__Exp2Test
#define nrn_cur _nrn_cur__Exp2Test
#define _nrn_current _nrn_current__Exp2Test
#define nrn_jacob _nrn_jacob__Exp2Test
#define nrn_state _nrn_state__Exp2Test
#define _net_receive _net_receive__Exp2Test 
#define state state__Exp2Test 
...
#define DA _ml->template fpfield<8>(_iml)
#define DA_columnindex 8
#define DB _ml->template fpfield<9>(_iml)
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"DA"} /* 8 */,
                                       _nrn_mechanism_field<double>{"DB"} /* 9 */,
 ...
 pnt_receive_size[_mechtype] = 1;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Exp2Test /home/ethan/nuerontest/exp2test.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/ethan/nuerontest/exp2test.mod";
